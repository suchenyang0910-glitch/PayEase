...
export function NotificationsPage({
  ...
  const copy = USER_SKELETON_COPY[language].notifications;
  return (
    <section
    ...
    >
      <header className="page__header">
        <h2 id="notifications-title" className="page__title">
          {copy.title}
        </h2>
      ...
      <div className="page__body" data-page-anchor="notifications">
        {children ?? (
